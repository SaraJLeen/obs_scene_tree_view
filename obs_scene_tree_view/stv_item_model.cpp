    ...
    : QStandardItem(text)
{
	...
	QIcon icon = config_get_bool(obs_frontend_get_app_config(), "SceneTreeView", "ShowFolderIcons") ?
    ...
    : QStandardItem(text)
{
	...
	QMainWindow *main_window = reinterpret_cast<QMainWindow*>(obs_frontend_get_main_window());
	QIcon icon = config_get_bool(obs_frontend_get_app_config(), "SceneTreeView", "ShowSceneIcons") ?
